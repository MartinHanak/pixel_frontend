...
export const login = createAsyncThunk<{username: string, jwt: string}, {inputUsername: string, inputPassword: string}, {state: RootState}>('login/login', async (arg, thunkAPI) => {
    try {
